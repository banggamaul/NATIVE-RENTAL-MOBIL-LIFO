...
<body>
    <?php
    include("konek.php");
    $cari = mysqli_query($konek, "SELECT * FROM sewa JOIN mobil ON sewa.id_mobil = mobil.id_mobil WHERE sewa.Id_admin='$_SESSION[id_admin]'");
        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    $riwayat = $_SESSION['id_admin'];
                    if (!empty($data) && is_array($data)) {
                        if ($data['id_admin'] == $riwayat){
